<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <form action="{{ route('work.store') }}" method="POST" id="formWorkItem">
            ...
            <div class="modal-body">
                @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Item No" name="item_no">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Pay item</label>
                        <input type="text" class="form-control" placeholder="Pay item" name="pay_item">
                    </div>
                    <div class="mb-3">
