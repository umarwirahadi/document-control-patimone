                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Phone number ex: +628" name="phone_1">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Phone number ex: +628" name="phone_2">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="email" autocomplete="off" class="form-control" placeholder="Primary email address"
                                name="primary_email">
                            </div>
                        </div>
                        <div class="col-md-6">
