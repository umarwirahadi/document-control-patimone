            ...
            <div class="modal-body">
                @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm data-focus" placeholder="Correspondence type" name="correspondence_type" >
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm data-focus" placeholder="Format number template" name="content_template" >
                    </div>
                    <div class="mb-3">
