    ...
    <div class="modal-content">
        <form action="{{ route('user.assign.store') }}" method="POST" id="formAssignUserPackage">
            <div class="modal-header bg-gradient-gray-dark">
                <h5 class="modal-title" id="staticBackdropLabel">Assign user</h5>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="user_id" value="{{$user->id}}">
                    <div class="mb-3">
                        ...
                        <select name="package_id[]" id="package_id" class="form-control form-control-sm control-select2" multiple>
                            {!!packageName()!!}
                        </select>
                    </div>
                    <div class="mb-3">
