    ...
    <div class="modal-content">
        <form action="{{ route('item.store') }}" method="POST" id="formItem">
            <div class="modal-header bg-info">
                <h5 class="modal-title" id="staticBackdropLabel">Create Quality Report</h5>
            ...
            <div class="modal-body">
                @csrf
                    <div class="mb-3">
                        <label class="form-label">Inspection Contents</label>
                        <div id="inspection_content"></div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Doc/Ref./ITP no</label>
