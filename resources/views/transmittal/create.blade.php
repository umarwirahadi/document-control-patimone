              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text" name="date_of_letter" class="form-control rounded-0 d-inline date-picker-3" placeholder="--select--">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <div class="form-group">                      
                      ...
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text">PTRPWJ/PTBP6/ENGR/24/T-</span>
                       </div>
                      <input type="text" name="incoming_ref_no" class="form-control rounded-0" placeholder="Number of transmittal">
                     </div>
                    </div>
                  </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select name="assigned_to" id="assigned_to" class="form-control rounded-0">
                    </select>
                  </div>
                </div>
              </div>
