          ...
          <div class="row mb-2">
              ...
              <div class="col-sm-6">
                  <div class="float-right">
                      <a href="{{route('transmittal.create')}}" class="btn btn-sm btn-primary btn-custom rounded-0"><i
                              class="fas fa-plus-circle"></i> Create</a>
                      <a href="{{route('transmittal.index')}}" class="btn btn-sm btn-success btn-custom rounded-0"><i
