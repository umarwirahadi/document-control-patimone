...
class ItemSeeder extends Seeder
{
    ...
    public function run()
    {
        $data=[
            ...
            ["item_code"=> "Male","item_name"=>"Male","item_category"=>"sex","item_status"=>1,'created_by'=>'f46d2647-0ad1-448e-b800-a88e080c9fb8'],
            ["item_code"=> "Female","item_name"=>"Female","item_category"=>"sex","item_status"=>1,'created_by'=>'f46d2647-0ad1-448e-b800-a88e080c9fb8'],
        ];
