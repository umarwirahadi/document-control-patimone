...
CREATE TABLE `patimone_model_has_permissions`  (
  ...
  `model_uuid` bigint(20) UNSIGNED NOT NULL,
  PRIMARY KEY (`permission_id`, `model_uuid`, `model_type`) USING BTREE,
  INDEX `model_has_permissions_model_id_model_type_index`(`model_uuid`, `model_type`) USING BTREE
);
...
CREATE TABLE `patimone_model_has_roles`  (
  ...
  PRIMARY KEY (`role_id`, `model_uuid`, `model_type`) USING BTREE,
  INDEX `model_has_roles_model_id_model_type_index`(`model_uuid`, `model_type`) USING BTREE
);
...
-- ----------------------------
BEGIN;
INSERT INTO `patimone_user_accesses` (`id`, `user_id`, `package_id`, `level`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES ('b01eef47-2e74-4425-8b00-f8d71250d41f', 'f46d2647-0ad1-448e-b800-a88e080c9fb8', '1e9fd856-6e81-470c-9835-c70ec9e69a6c', 'dc', '1', 'f46d2647-0ad1-448e-b800-a88e080c9fb8', NULL, '2024-04-03 07:53:20', '2024-04-03 07:53:20'), ('e948795b-9301-4265-b4d9-818111888582', 'f46d2647-0ad1-448e-b800-a88e080c9fb8', '62116337-ba4d-470d-8478-a41c49a9769d', 'dc', '0', 'f46d2647-0ad1-448e-b800-a88e080c9fb8', NULL, '2024-04-03 10:03:43', '2024-04-03 10:03:43');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `patimone_users` (`id`, `name`, `email`, `email_verified_at`, `social_id`, `social_type`, `package_id`, `engineer_id`, `level`, `password`, `remember_token`, `deleted_at`, `created_at`, `updated_at`) VALUES ('f46d2647-0ad1-448e-b800-a88e080c9fb8', 'Umar Wirahadi', 'admin@localhost.com', NULL, NULL, NULL, '1e9fd856-6e81-470c-9835-c70ec9e69a6c', '0f679e57-29df-44b2-a21f-d9ff92cf3b4d', 'user', '$2y$10$I7O0824QY3F6ooIc9KP0nuyuEFUcxCItFuGoJ2lphfzfwV8kkZTBe', NULL, NULL, NULL, NULL);
COMMIT;
